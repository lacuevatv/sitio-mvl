...
$fechaAgendaOut  = isset($dataPost['fechaAgendaOut']) ? $dataPost['fechaAgendaOut'] : '';
$lugarAgenda     = isset($dataPost['lugarAgenda']) ? $dataPost['lugarAgenda'] : '';
...
<div class="contenido-modulo">
	...
	<div class="container">
		...
		<input type="hidden" name="post_categoria" value="agenda">
	...
	<!------ IMAGENES DE LA GALERIA DE LA NOTICIA ---------->
			...
			<div class="row">
				<div class="col-30">
			   		<div class="form-group">
			   			<label for="post_fecha_agenda" class="larger-label">Fecha In Agenda</label>
						<input id="post_fecha_agenda" name="post_fecha_agenda" type="date" value="<?php echo $fechaAgenda?>">
					</div>
				</div><!-- // col -->
				<div class="col-30">
			   		<div class="form-group">
			   			<label for="post_fecha_agenda_out" class="larger-label">Fecha Out Agenda</label>
						<input id="post_fecha_agenda_out" name="post_fecha_agenda_out" type="date" value="<?php echo $fechaAgendaOut?>">
					</div>
				</div><!-- // col -->
				<div class="col-30">
			   		<div class="form-group">
			   			<label for="post_lugar_agenda" class="larger-label">Lugar agenda</label>
						<input id="post_lugar_agenda" name="post_lugar_agenda" type="text" value="<?php echo $lugarAgenda?>">
					</div>
				</div><!-- // col -->
			</div>
			<hr>
...
<footer class="footer-modulo container">
    ...
    <a type="button" href="index.php?admin=agenda" class="btn">Volver a agenda</a>
    <a type="button" href="index.php?admin=editar-agenda" class="btn">Agregar nueva</a>
</footer>
