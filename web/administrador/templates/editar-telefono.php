...
<div class="contenido-modulo">
	<div class="container">
		...
		<input type="hidden" name="post_categoria" value="telefonos">
	...
	<!------ PERSONALIZAR URL DE LA NOTICIA ---------->
			...
			<div class="row">
				<div class="col-70">
					...
					<div class="form-group">
						<label for="post_contenido" class="larger-label">Número de teléfono a mostrar</label>
						<input name="post_contenido" value="<?php echo $contenido; ?>">
					</div>
				</div><!-- // col -->
	<!------ PUBLICAR LA NOTICIA ---------->	
				<div class="col-30">
	...
	<!------ RESUMEN DE LA NOTICIA ---------->
					<div class="form-group">
						<label for="post_resumen" class="larger-label">Texto opcional para busqueda</label>
	...
	<!------ IMAGEN DESTACADA DE LA NOTICIA ---------->
					<div id="imagen_destacada_wrapper" class="form-group">
						<label for="post_imagen" class="larger-label">Icono </label>
...
<footer class="footer-modulo container">
    ...
    <a type="button" href="index.php?admin=telefonos" class="btn">Volver a teléfonos</a>
