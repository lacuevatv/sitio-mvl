...
/*
 * Educacion
 * Lista los links de educación creada y con links para verlas, editarlas o publicarlas
 * Since 3.0
 * 
*/
global $userStatus;
	...
	<div class="container">
		...
		<div class="row">
            ...
            <?php 
                ...
                $posts = listaNoticiasData(20, 'all', 'educacion' ); 
                    ...
                    <li>
                        <article>
                            ...
                            <div class="wrapper-button">
                                <a href="index.php?admin=editar-educacion&slug=<?php echo $post['post_url']; ?>" class="btn btn-primary btn-sm">
                                    Editar
                                </a>
    	...
    	<div class="row">
    		<div class="col ver-mas-noticias">
    			<input type="hidden" name="post_categoria" id="post_categoria" value="educacion">
