...
/*
 * Noticias recientes
 * Lista los links del footer, cada uno con su icono.
 * Since 3.0
 * 
*/
global $userStatus;
	...
	<div class="container">
		...
		<div class="row">
            ...
            <?php 
                ...
                $posts = listaNoticiasData(20, 'all', 'links-footer' ); 
                    ...
                    <li>
                        <article>
                            ...
                            <div class="wrapper-button">
                                <a href="index.php?admin=editar-links&slug=<?php echo $post['post_url']; ?>" class="btn btn-primary btn-sm">
                                    Editar
                                </a>
    	...
    	<div class="row">
    		<div class="col ver-mas-noticias">
    			<input type="hidden" name="post_categoria" id="post_categoria" value="links-footer">
...
<footer class="footer-modulo container">
    ...
    <a type="button" href="index.php?admin=editar-links" class="btn">Agregar nueva</a>
</footer>
