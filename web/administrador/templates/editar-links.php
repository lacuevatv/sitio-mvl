<?php
/*
 * Editar link / Nueva link
 * Edita los links del footer, cada uno con su icono.
 * Since 3.0
 * 
*/
global $userStatus;
...
<div class="contenido-modulo">
	...
	<div class="container">
		...
		<input type="hidden" name="post_categoria" value="links-footer">
...
<footer class="footer-modulo container">
    ...
    <a type="button" href="index.php?admin=links-footer" class="btn">Volver a Links</a>
    <a type="button" href="index.php?admin=editar-links" class="btn">Agregar nuevo</a>
</footer>